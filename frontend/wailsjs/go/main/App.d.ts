...
import {eztoolparser} from '../models';
...
export function GetCurrentDBInfo():Promise<main.DBInfo>;
...
export function ImportFolderRecursive():Promise<eztoolparser.ImportSummary>;
